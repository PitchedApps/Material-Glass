...
public class QuickScroll extends View
{
	...
	// base colors
	public static final int GREY_DARK = Color.parseColor("#88ffffff");
	public static final int GREY_LIGHT = Color.parseColor("#88000000");
	public static final int GREY_SCROLLBAR = Color.parseColor("#22ffffff");
	public static final int BLUE_LIGHT = Color.parseColor("#77ffffff");
	public static final int BLUE_LIGHT_SEMITRANSPARENT = Color.parseColor("#22000000");
